...
import sys
sys.path.append('/home/muratbal/RSIFTNet/')

from models.riresnet18 import RIResNet18, RIResidualBlock, GroupConv2d, random_rot_data, is_rotated_90_degree
from models.rifpnfe18 import RIFPNFE_ResNet18
from models.fpnfe18 import FPNFE_ResNet18
...
class RSIFTNet_(BaseModel):
    ...
    #checkpoint_url = 'file:///home/muratbal/ThesisWorkshop/RSIFTNet/checkpoints/RIFPNFE_ResNet18-64-E770.pth'
    #checkpoint_url = 'file:///home/muratbal/ThesisWorkshop/RSIFTNet/checkpoints/FPNFE_ResNet18-64-E800.pth'
    checkpoint_url = 'file:///home/muratbal/RSIFTNet/checkpoints/FPNFE_ResNet18-128-E1000-L1_0.081-L2_0.004.pth'


    def _init(self, conf):
        #self.model = RIFPNFE_ResNet18() 
        self.model = FPNFE_ResNet18() 

        ret = self.load_state_dict(
            torch.hub.load_state_dict_from_url(str(self.checkpoint_url)), strict=False
        )

        print('Load state dict :', ret)
    ...
    def _forward(self, data):
        ...
        pred["keypoint_scores"] = torch.concat(result["kp"], 3)
        result["features"] = einops.rearrange(result["features"], 'b h w f -> b f h w') 
        #scores = torch.concat(result["kp"], 3)
        scores = result["kp"][2]
        kp_x = result["kp"][0]
        kp_y = result["kp"][1]
        pred["descriptors"] = result["features"]
        dense_desc = result["features"]      
